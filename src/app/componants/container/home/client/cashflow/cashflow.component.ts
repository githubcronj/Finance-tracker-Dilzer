...
export class CashflowComponent implements OnInit, OnDestroy {
    ...
    public activeTab = 0;
    private submenuList = ['Dashboard', 'Incomes', 'Expenses', 'Committed Savings', 'Committed Repayments'];
    ...
    public detectTabChange() {
        this.activeTab = this.sidemenu.activeTab;
        this.changeDetector.detectChanges();
        this.router.navigate(['/auth/admin/client-details/' + this.clientId], { queryParams: { selected: 3, selectedSubIndex: this.activeTab } });
